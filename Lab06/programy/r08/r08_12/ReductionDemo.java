...
public class ReductionDemo
{
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("sum of digits of pi: " + sum);
        
        values = Stream.empty();
        sum = values.reduce((x, y) -> x + y); // Or values.reduce(Integer::sum);
        System.out.println("sum of the empty stream: " + sum);
        
        values = Stream.of(digits);
        Integer sum2 = values.reduce(0, (x, y) -> x + y);
        System.out.println("sum2i of digits of pi: " + sum2);
        
        values = Stream.empty();
        Integer sum3 = values.reduce(0, (x, y) -> x + y);
        System.out.println("sum3 of the empty stream: " + sum3);
